...
export default function Wardrobe() {
  ...
  const revendre = async (item: Item) => {
    const res = await fetch("/api/revente", { method: "POST", body: JSON.stringify(item) });
  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-6xl px-4 py-8">
        <h1 className="text-2xl font-bold mb-4 opacity-0 animate-fade-in">Ma garde-robe avec Anna</h1>
